...
import UserProfileScreen from './src/screens/UserProfileScreen'; // NEW: Added User Profile Import
...
export default function App() {
  ...
  useEffect(() => {
    // Initial App Loading for 5 seconds
    ...
    <SafeAreaProvider>
      <NavigationContainer>
        <Stack.Navigator screenOptions={{ headerShown: false }} initialRouteName="Login">
          ...
          {/* NEW: Added User Profile Screen to Navigator */}
